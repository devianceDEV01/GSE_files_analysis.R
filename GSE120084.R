...
gc()
#Figure 2b
VlnPlot(data,features = c('MRC1','DDX58','IFIH1','DHX58','SEC14L1','NFKB1','IL1B','CD274','MILR1'),idents = c('IFNY.LPS','IL4'),cols = c('red','skyblue'))
FindMarkers(data, ident.1 = 'IFNY.LPS', ident.2 = 'IL4', features = c('MRC1','DDX58','IFIH1','DHX58','SEC14L1','NFKB1','IL1B','CD274','MILR1'))
