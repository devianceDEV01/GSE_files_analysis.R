...
names<-c(paste0("adjacent_", 1:4969))
...
genes2 <- read_tsv("features.tsv.gz", col_names = FALSE)
gene_ids2 <- genes2$X2
head(gene_ids2)
...
EnhancedVolcano(resLRT,
                ...
                x='log2FoldChange',
                y='pvalue',
                title = 'Differential gene expressions from PDA tumors vs paired adjacent tissue',
...
go <- enrichGO(gene = genes$entrezgene_id,
               OrgDb = org.Hs.eg.db,
               ont = "BP")
pathways<-c('GO:0002573','GO:0002274','GO:0030099','GO:0097529','GO:0002262',
            'GO:0002761','GO:0002275','GO:0061515','GO:0045639','GO:0002444',
            'GO:0002763','GO:0001773','GO:0061082')
